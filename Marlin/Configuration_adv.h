...
#define ADVANCED_PAUSE_FEATURE
  ...
  #ifndef Q5                                                  // This short retract is done immediately, before parking the nozzle.
 ...
 */
  ...
  #if AXIS_IS_TMC(X2)
    #define X2_CURRENT      XYZ_CURRENT
    #define X2_CURRENT_HOME XYZ_CURRENT_HOME
  ...
  #if AXIS_IS_TMC(Y2)
    #define Y2_CURRENT      XYZ_CURRENT
    #define Y2_CURRENT_HOME XYZ_CURRENT_HOME
