...
#define STRING_CONFIG_H_AUTHOR "(Foxies-CSTL, FLSUN_ΔDeltas)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ΔDeltaFox"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // FLSUNQ 1.6mm aluminium heater with 4mm lattice glass
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 280.6
    #define DELTA_HEIGHT 380.8632
    #define DELTA_ENDSTOP_ADJ { 0.0000, -0.0, 0.0 }
    #define DELTA_RADIUS 141.0 
    #define DELTA_TOWER_ANGLE_TRIM { 0.0, 0.0, 0.0 }  //XYZ
    #define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.0, 0.0, 0.0 }
    //#define DELTA_DIAGONAL_ROD_TRIM_TOWER { -0.0896, 0.2582, -0.1686 }    //ABC
    #define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 }
  #endif
#endif
...
#ifndef QSR
  #define EXTRUDER_STEPS 396
#else
  #define EXTRUDER_STEPS 1444
#endif
// delta speeds must be the same on xyz
...
#define XY_PROBE_FEEDRATE (50*60) //(17*60) //1000 (66*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (40*60) //2400

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 8 )  //300 //200
