...
//
#define STOCK
#define DRIVER_AXES TMC2208 //TMC2209TMC2208_STANDALONE
#define DRIVER_EXT  TMC2208 //TMC2209
//#define INV_EXT
//#define Q5
#define XP
//===========================================================================
...
#define STRING_CONFIG_H_AUTHOR "(Foxies, PandaPi marlin  config)" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

/* PANDAPIV28 =  0 => U6 PANDAPIV28 OCTO */// PandaPi shield for raspberry Pi printer
/* PANDAPIV28 =  1 => U8 PANDAPIV28_STM32 */
/* PANDAPIV28 =  2 => U8 KLIPPER */
#define PANDAPI
#define PANDAPIV28  0
#if PANDAPIV28 < 1
  #define PANDAPI  1
...
//For TMC220x
#define XYZ_CURRENT		    900 	   // (mA) RMS current. Multiply by 1.414 for peak current.
#define XYZ_CURRENT_HOME	800 	   // (mA) RMS current. Multiply by 1.414 for peak current.
#define E_CURRENT     		850 	   // (mA) RMS current. Multiply by 1.414 for peak current.
//#define E2_CURRENT_PI		850 	   // (mA) RMS current. Multiply by 1.414 for peak current.
...
#else
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -18 }  //OPT (QQS -16.2) (Q5 -18)
#endif
...
#define XY_PROBE_SPEED (66*60)    //4000

// Feedrate (mm/m) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST (40*60)  //2400

// Feedrate (mm/m) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 4) //600
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way.
  ...
  #else
    #define INVERT_E0_DIR true  //Q5_A4988  // TITAN Extruder
  #endif
#endif
// @section extruder
